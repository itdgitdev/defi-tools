...
from configured_pool_rebalancer.models import WorkerConfig
from configured_pool_rebalancer.pnl_report import ConfiguredPoolPnlReporter, _normalize_tx_hash
...
class PnlGasLookupTests(unittest.TestCase):
    ...
    def test_db_lookup_strips_prefix_in_sql_match(self):
        ...
        with patch("configured_pool_rebalancer.pnl_report.get_connection", return_value=connection):
